...
//            mEmptyInfoView.setVisibility(View.GONE);
    ...
    private class MyAdapter extends RecyclerView.Adapter<FragmentFavorite.MyAdapter.ViewHolder> {

        @NonNull
        @Override
        public FragmentFavorite.MyAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            LayoutInflater inflater = LayoutInflater.from(parent.getContext());
            View content = inflater.inflate(R.layout.charge_station_brief, parent, false);
            return new FragmentFavorite.MyAdapter.ViewHolder(content);
        }

        @Override
        public void onBindViewHolder(@NonNull FragmentFavorite.MyAdapter.ViewHolder holder, int position) {
            Record record = ChargeStationFinderActivity.favorites.get(position);
